...
#define DEVICE_NAME "G31 sketch for simhub made by davisod(credits to jetski and dxr1us)" //{"Group":"General","Name":"DEVICE_NAME","Title":"Device name,\r\n make sure to use a unique name when using multiple arduinos","DefaultValue":"SimHub Dash","Type":"string","Template":"#define DEVICE_NAME \"{0}\""}
#define DEVICE_UNIQUE_ID "4131a6fe-af33-4eae-8583-6d8c34aab7cb" //{"UniqueId":"4131a6fe-af33-4eae-8583-6d8c34aab7cb","Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
